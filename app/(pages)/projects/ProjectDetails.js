...
export default function ProjectDetails({ project }) {
    ...
    const addMemberBtnStye = "rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 ml-3 cursor-pointer"
    if (!project) {
            ...
            <div className='flex items-center justify-center h-screen'>
                <div className="p-6 bg-white shadow-lg rounded-lg">
                    ...
                    <div className="flex items-center ">
                        ...
                        <p className={addMemberBtnStye} onClick={handleAddMember}>Add Member</p>
                    </div>
